...
{
    return YES;//SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"9.0");
}

inline static BOOL isIOS8OrLater()
{
    return YES;//SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"8.0");
}

inline static BOOL isIOS7OrLater()
{
    return NO;//SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0");
}

inline static BOOL isIOS6OrLater()
{
    return NO;//SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"6.0");
}
